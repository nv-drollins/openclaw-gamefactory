...
openclaw --profile "$PROFILE" config set agents.defaults.skills '["game-factory"]' --strict-json >>"$SETUP_LOG" 2>&1
...
echo "OpenClaw profile '$PROFILE' is restricted to the game-factory skill"
